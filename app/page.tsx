  ...
  return (
    <div className="min-h-[100dvh] w-full">
      ...
      >
        ...
        <div>
          <h1 className="text-[11px] font-bold tracking-[0.15em] uppercase text-cyan-400">
            System Nexus
          </h1>
      ...
      {/* ── Hero ───────────────────────────────────────── */}
      <section className="px-5 md:px-8 pt-10 md:pt-14 pb-10 text-center animate-fade-in relative">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-4 leading-[1.08] drop-shadow-[0_0_25px_rgba(34,211,238,0.3)]">
          <span style={{ color: "var(--fg)" }}>YOUR </span>
          <span className="text-gradient-vivid uppercase">AI WORKSPACE</span>
        </h1>
        <p
          className="text-sm md:text-base max-w-xl mx-auto px-4 leading-relaxed uppercase tracking-wider"
        ...
        <div className="flex items-center justify-center gap-6 mt-8">
          {stats.map((s, i) => (
            <div key={i} className="text-center">
              <div className="text-xl md:text-2xl font-bold text-gradient-brand">{s.value}</div>
              <div
      ...
      <section className="px-5 md:px-8 pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {moduleItems.map(({ href, icon: Icon, label, description, accent }, i) => (
            <Link
              key={href}
              href={href}
              className="module-card group p-5 flex flex-col gap-4"
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(400px circle at 50% 0%, ${accent}15, transparent 70%)`,
                }}
              />
              ...
              <div className="relative z-10 flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3
                    className="font-bold text-[11px] mb-1 transition-colors uppercase tracking-[0.1em] group-hover:text-white"
              ...
              {/* Bottom accent line */}
              <div
                className="relative z-10 h-[2px] w-0 group-hover:w-full transition-all duration-500 rounded-full mt-2"
                style={{
      ...
      <section className="px-5 md:px-8 pb-16 text-center">
        <div
          className="glass-card p-6 md:p-8 max-w-xl mx-auto border border-cyan-500/20 bg-[#0a0c18]/80 shadow-[inset_0_0_30px_rgba(34,211,238,0.1)]"
        >
          <div
          ...
          <h3 className="text-sm font-black uppercase tracking-[0.15em] mb-2 text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]">
          ...
          <Link
            ...
            style={{ borderRadius: "8px", boxShadow: "0 0 15px rgba(99,102,241,0.5)" }}
          >
            LAUNCH GENERAL CHAT
            <ArrowRight size={15} />
          </Link>
